...
% Last Modified by GUIDE v2.5 13-Jun-2019 15:03:32
...
matlabImage = imread('./img/background.jpeg');
image( matlabImage)
axis off
axis image
%%
...
% --- Executes on button press in LipidMatch.
function LipidMatch_Callback(hObject, eventdata, handles)
% hObject    handle to LipidMatch (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
LipidMatch
