...
classdef Controller < biotracs.core.mvc.controller.Controller
    ...
    methods
        ...
        function  convertAction( this )
            convertDesign = this.userConfigTable.get('CONVERT');
        ...
        function extractionAction( this )
            convertDesign = this.userConfigTable.get('EXTRACT');
        ...
        function linkingAction( this )
            convertDesign = this.userConfigTable.get('LINK');
        ...
        function preprocessingAction( this )
            convertDesign = this.userConfigTable.get('PREPROCESS');
    ...
    methods(Access = protected)
        ...
        function doInit( this, varargin )
            ...
            if ~isfile(p.Results.UserConfigFilePath)
                error('BIOTRACS:Mimosa:FileNotFound', 'No user configuration file found');
            end
